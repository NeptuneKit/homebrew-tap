...
class Triton < Formula
  ...
  on_intel do
    url "https://github.com/NeptuneKit/TritonKit/releases/download/v0.1.11/triton-macos-x86_64.tar.gz"
    sha256 "be03e43e93dc20cd4bcdbdc6af7c7b04b9411624c08c10090ff636d5b005eb97"
  end
