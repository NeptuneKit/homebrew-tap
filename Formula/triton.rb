...
class Triton < Formula
  ...
  on_intel do
    url "https://github.com/NeptuneKit/TritonKit/releases/download/v0.1.35/triton-macos-x86_64.tar.gz"
    sha256 "7acf00be4c064d8a053180b5339155cd8286be1ce380cc14c5a61c4871ddfa3d"
  end
