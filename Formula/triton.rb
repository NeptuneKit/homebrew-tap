...
class Triton < Formula
  ...
  on_intel do
    url "https://github.com/NeptuneKit/TritonKit/releases/download/v0.1.8/triton-macos-x86_64.tar.gz"
    sha256 "19db8e2c79def68c7d495fc8c039996682ea396d8acbf2701f10be29c23a219d"
  end
