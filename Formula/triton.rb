...
class Triton < Formula
  ...
  on_intel do
    url "https://github.com/NeptuneKit/TritonKit/releases/download/v0.2.5/triton-macos-x86_64.tar.gz"
    sha256 "f6b6ff04ae7ed64749c8b3f4a03f73d57e3b464c9469693ab9240cf5f472f64f"
  end
