...
class Triton < Formula
  ...
  on_intel do
    url "https://github.com/NeptuneKit/TritonKit/releases/download/v0.1.10/triton-macos-x86_64.tar.gz"
    sha256 "8ae1d10f316f569d6132b835eee1889b85a9e0d3661d6b1219e4fd582c6ae9db"
  end
